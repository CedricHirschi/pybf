...
def make_video(dataset_file_path, db_range=50, video_fps=60, save_path=None):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--db_range", type=float, default=50, help="Db range of images")
    parser.add_argument(
        "--video_fps", type=float, default=60, help="FPS of output video"
    )
    ...
    # Run main function
    make_video(
        FLAGS.dataset_file_path, db_range=FLAGS.db_range, video_fps=FLAGS.video_fps
    )
