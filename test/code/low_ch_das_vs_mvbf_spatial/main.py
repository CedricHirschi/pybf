...
dataset_path_contrast = (
    path_to_lib + "/pybf/tests/data/Picmus/contrast_speckle/rf_dataset.hdf5"
)
...
tx_strategy = [
    "PW_4_2",
    [
        data_loader_obj_contrast.tx_strategy[1][33],
        data_loader_obj_contrast.tx_strategy[1][37],
        data_loader_obj_contrast.tx_strategy[1][38],
        data_loader_obj_contrast.tx_strategy[1][42],
    ],
]
rf_data_shape = (len(tx_strategy[1]),) + data_loader_obj_contrast.get_rf_data(
    0, 0
).shape
...
bf = BFCartesianReference(
    data_loader_obj_contrast.f_sampling,
    tx_strategy,
    data_loader_obj_contrast.transducer,
    decimation_factor,
