...
dataset_path_resolution = (
    path_to_lib + "/pybf/tests/data/Picmus/resolution_distorsion/rf_dataset.hdf5"
)
...
# %%
bf = BFGlobalMVBF(
    data_loader_obj_resolution.f_sampling,
    tx_strategy,
    data_loader_obj_resolution.transducer,
    decimation_factor,
...
circle_pos = np.asarray(
    [[-0.00022, 0.01867, 0.002, 0.0005], [-0.0105, 0.0281, 0.007, 0.0039]]
)

CNR_values = eval_obj.evaluate_circ_contrast(circle_pos)


scatterer_pos = np.asarray(
    [
